        ...
        <table class="table-auto w-11/12 ">
          <thead className="bg-neutral-100">
            <tr className="font-thin uppercase outline-1 outline-gray-200 outline rounded-sm">
              ...
              <th className="p-3 font-normal">Account Created</th>
              <th className="p-3 font-normal">Coins Held</th>
          ...
          <tbody>
            <tr className="outline-1 outline-gray-200 outline rounded-sm ">
              ...
              <td className="text-sm">jane@email.com</td>
              <td className="text-sm">21</td>
              <td className="text-sm">21/11/22</td>
