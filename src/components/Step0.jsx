...
const Step0 = ({ setStep }) => {
  ...
  return (
    <div className="p-10">
      <h3 className="text-4xl pb-5 text-primary-500">
        Saved Episodes
      </h3>
      <h3 className="text-xl my-7 text-primary-500">
        Saved Winning Numbers
      </h3>
      ...
      <table class="md:table-auto w-11/12 m-auto ">
          ...
          <tbody>
            <tr className="outline-1 outline-gray-200 outline rounded-sm ">
              ...
              <td className="text-sm p-3 max-md:hidden">
                1
              </td>
              <td className="text-sm max-md:hidden">21/11/22</td>
              <td className="text-sm max-md:hidden">18:30</td>
              <td className="text-base cursor-pointer text-primary-500 max-md:hidden">view</td>
